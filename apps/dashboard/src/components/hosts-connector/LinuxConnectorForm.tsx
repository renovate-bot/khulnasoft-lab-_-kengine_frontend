      ...
      <Stepper>
        ...
        >
          <div className="text-p7a text-text-text-and-icon">
            ...
            <DFLink
              href={`https://community.khulnasoft.com/threatmapper/docs/v2.2/sensors/linux-host`}
              target="_blank"
              rel="noreferrer"
              className="mt-2"
            >
        ...
        >
          <div>
            <p className="mb-2.5 text-p7a text-text-text-and-icon">
              ...
              <DFLink
                href={`https://community.khulnasoft.com/threatmapper/docs/v2.2/sensors/linux-host#threatmapper-sensor-agents`}
                target="_blank"
                rel="noreferrer"
                className="mt-2"
              >
        ...
        >
          <div>
            ...
            <Card className="w-full relative py-2 px-4">
              <Command command="sudo bash install_kengine_agent.sh" />
            </Card>
          </div>
          <div className="mt-4">
            <p className="mb-2.5 text-p7a text-text-text-and-icon">
              This will also create a new file <b>uninstall_kengine.sh</b>. You can run
              to to uninstall Khulnasoft agent.
            </p>
            <Card className="w-full relative py-2 px-4">
              <Command command="sudo bash uninstall_kengine.sh" />
            </Card>
          </div>
        </Step>
      </Stepper>
