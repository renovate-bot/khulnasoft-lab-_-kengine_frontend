...
export function getSettingsApiClient() {
  ...
  return {
    ...
    generateKengineLicense: settingsApi.generateLicense.bind(settingsApi),
    registerKengineLicense: settingsApi.registerLicense.bind(settingsApi),
    getKengineLicense: settingsApi.getLicense.bind(settingsApi),
    deleteKengineLicense: settingsApi.deleteLicense.bind(settingsApi),
