...
const Connector = () => {
  ...
  if (ACCOUNT_CONNECTOR.DOCKER === connectorType) {
    ...
    description = 'Deploy all modules for Khulnasoft Scanner at your docker container.';
  } else if (ACCOUNT_CONNECTOR.KUBERNETES === connectorType) {
    title = 'Connect a Kubernetes Cluster';
    description = 'Deploy all modules for Khulnasoft Scanner at your kubernetes cluster.';
  } else if (ACCOUNT_CONNECTOR.LINUX === connectorType) {
    title = 'Connect a Linux Machine';
    description = 'Deploy all modules for Khulnasoft Scanner at your linux machine.';
  } else if (ACCOUNT_CONNECTOR.AWS === connectorType) {
    title = 'Connect to Amazon Web Services';
    description = 'Deploy all modules for Khulnasoft Scanner at your aws cloud.';
    ...
    description = 'Deploy all modules for Khulnasoft Scanner at your azure cloud.';
  } else if (ACCOUNT_CONNECTOR.GCP === connectorType) {
    title = 'Connect to Google Cloud';
    description =
      'Deploy all modules for Khulnasoft Scanner at your google cloud platform.';
